...
export type TSqlDistrictDetailInsert = {
    district_code: string;
    name_en: string;
} & Partial<Omit<TSqlDistrictDetail, "district_code" | "name_en">>;
export type TSqlDistrictDetailUpdate = Partial<Omit<TSqlDistrictDetail, "district_code" | "created_at">>;
export declare const DB_COLUMNS_DISTRICT_LIST_FOR_ADMIN: string[];
export declare const KEYS_DISTRICT_STR: string[];
export declare const KEYS_DISTRICT_NUM: string[];
export declare const KEYS_DISTRICT_BOOL: string[];
export declare const KEYS_DISTRICT_STR_ARRAY: never[];
