 ...
 * 지원 언어 코드 배열
 */
export const SUPPORT_LANG_CODES = ["ko", "zh", "ja", "th", "vi", "id", "es", "pt", "fr", "de", "it", "nl"];

/**
 * 지원 언어 코드
 */
export type SUPPORT_LANG_CODE_TYPE = "ko" | "zh" | "ja" | "th" | "vi" | "id" | "es" | "pt" | "fr" | "de" | "it" | "nl";
